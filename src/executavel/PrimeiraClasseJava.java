...
public class PrimeiraClasseJava {
	public static void main(String[] args) {
		...
		String idade = JOptionPane.showInputDialog("Qual sua idadde?");
		...
		aluno1.setNome(nome);
		aluno1.setIdade(Integer.valueOf(idade));   		/*converter de String para int*/
		aluno1.setDataNasc(dataNasc);
		aluno1.setNota1(Double.parseDouble(nota1));		/*converter de String para double*/
